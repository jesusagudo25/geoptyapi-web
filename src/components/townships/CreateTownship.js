...
const CreateTownship = () => {
    ...
    const stored = async (e) => {
        e.preventDefault();
        await axios.post('api/township', {
            id: code, //En realidad no es id, sino code
            name: name,
            district_id: id
        })
        navigate(`/district/${id}/townships`)
    }
    ...
    return (
        <section className='text-gray-600 body-font'>
            <div className='container px-5 py-24 mx-auto'>
                <h2 className='text-gray-900 text-xl mb-1 font-medium title-font'>Create District for {nameDistrict}</h2>
